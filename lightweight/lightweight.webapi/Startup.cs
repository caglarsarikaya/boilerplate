...
using lightweight.core.UnitOfWorks;
using AutoMapper;
...
namespace lightweight.webapi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //addTranslent, her seferınde yeniden uretır addscoped daha performanslı
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v2", new OpenApiInfo
                {
                    ...
                    {
                        Name = "Çağlar Can SARIKAYA",
                        Email = "caglarcansarikaya@gmail.com",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, AppDbContext lw)
        {
